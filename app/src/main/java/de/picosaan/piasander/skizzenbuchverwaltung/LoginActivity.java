...
public class LoginActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                //https://console.developers.google.com/apis/credentials?project=skizzenbuecher&authuser=0 Webanwendung, nicht Android!
                .requestIdToken("256383817889-n3bmsn626qoh3mclf3gqcq4d00gikr6s.apps.googleusercontent.com")
                .requestEmail()
                .build();
